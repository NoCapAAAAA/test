...
def generate_pdf_check(order):
    ...
    pdf.cell(200, 10, txt=f'НДС 18%                                                                                                                                  {order.get_nds()}', ln=1, align='C')
    pdf.cell(200, 10, txt=f'___________________________________________________________________________________________________________',ln=1, align='C')
    pdf.cell(200, 10, txt='N ФН                                                                                                       0000999999999999', ln=1, align='C')
    pdf.cell(200, 10, txt='регистрационный номер ККТ                                                                                  0000999999999999', ln=1, align='C')
    pdf.cell(200, 10, txt='=N ФД                                                                                                       7651283', ln=1, align='C')
    pdf.cell(200, 10, txt='=ФП                                                                                                       897564536789',ln=1, align='C')
    pdf.cell(200, 10,txt=f'___________________________________________________________________________________________________________',ln=1, align='C')
    pdf.set_font('DejaVu', size=25)
